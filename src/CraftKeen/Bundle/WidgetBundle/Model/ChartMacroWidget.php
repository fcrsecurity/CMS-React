...
class ChartMacroWidget extends AbstractWidget implements SecurityContextAwareInterface
{
    ...
    {
        return array_merge(parent::getTemplateData(), ['editable' => $this->getUser() ? true : false]);
    }
