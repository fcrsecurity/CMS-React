...
class RichEditorWidget extends AbstractWidget implements SecurityContextAwareInterface
{
    ...
    public function getTemplateData()
    {
        return array_merge(parent::getTemplateData(), [
            'logged' => $this->getUser() ? true : false,
            'allow_edit' => $this->isGranted('canedit', $this->source->getPage()),
        ]);
    }
