...
class LoadCareersSliderData extends AbstractAliceFixture implements ContainerAwareInterface, DependentFixtureInterface
{
    ...
    {
        parent::loadFromFile(dirname(__FILE__) . '/Data/careers_slider.yml', $manager);
    }
