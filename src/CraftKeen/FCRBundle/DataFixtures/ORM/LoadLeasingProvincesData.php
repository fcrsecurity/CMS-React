...
class LoadLeasingProvincesData extends AbstractAliceFixture implements ContainerAwareInterface, DependentFixtureInterface
{
    ...
    {
        parent::loadFromFile(dirname(__FILE__) . '/Data/leasing_provinces.yml', $manager);
    }
