...
class LoadCareersEmployeeData extends AbstractAliceFixture implements ContainerAwareInterface, DependentFixtureInterface
{
    ...
    {
        parent::loadFromFile(dirname(__FILE__) . '/Data/careers_employee.yml', $manager);
    }
