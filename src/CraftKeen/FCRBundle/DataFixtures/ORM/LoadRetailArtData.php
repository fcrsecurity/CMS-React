...
class LoadRetailArtData extends AbstractAliceFixture implements ContainerAwareInterface, DependentFixtureInterface
{
    ...
    {
        parent::loadFromFile(dirname(__FILE__) . '/Data/retail_art.yml', $manager);
    }
