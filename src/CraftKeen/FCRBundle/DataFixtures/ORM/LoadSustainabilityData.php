...
class LoadSustainabilityData extends AbstractAliceFixture implements ContainerAwareInterface, DependentFixtureInterface
{
    ...
    {
        parent::loadFromFile(dirname(__FILE__) . '/Data/sustainability.yml', $manager);
    }
