...
class TeamTabsWidget extends AbstractWidget implements
    ...
    LanguageProviderAwareInterface
{
    ...
    {
        return array_merge(parent::getTemplateData(), ['leasing_provinces' => $this->getData()]);
    }

    /**
     * @return array|ActiveProvince[]
     */
    protected function getData()
    {
        return $this->getRepository(ActiveProvince::class)->findProvincesMap(
