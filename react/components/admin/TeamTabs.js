               ...
               <div className="available-text">
                    ...
                    <form action="#" id="careers-form">
                        <div className="wrap-subscribe">
                            ...
                            <input type="email" name="careers[email]" placeholder="Email" className="input-s"/>
                            <input type="hidden" name="careers[careers]" value="1"/>
                            <button className="subscribe-btn">SUBSCRIBE <i className="fa fa-angle-right" aria-hidden="true"></i></button>
                        </div>
                    </form>     
                </div>
            )
